...
function submitForm(){
  ...
  .then(function() {
    ...
    $("#memeberSubmit").removeClass().addClass(msgClasses).text('Welcome To DSC Unimelb ' + inputName + '. Your are now a ' + inputStack + ' student.');
    alert('welcome to DSC Unimelb ' + inputName + '. Your membership has been registered to learn ' + inputStack)
  })
